...
const variantStyles = {
    filled: 'bg-gray-100 text-white dark:bg-gray-800 border border-transparent focus:ring-2 focus:ring-offset-1',
    outlined: 'bg-transparent text-white border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-offset-1',
};

const colorStyles = {
    primary: {
        filled: 'focus:ring-blue-500',
    ...
    danger: {
        ...
        outlined: 'border-red-500 focus:ring-red-500',
    },
};
